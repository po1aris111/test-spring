...
public abstract class AdviceModeImportSelector<A extends Annotation> implements ImportSelector {
	...
	public final String[] selectImports(AnnotationMetadata importingClassMetadata) {
		//  如果开启了EnableTransactionManagement注解，getClass() = TransactionManagementConfigurationSelector
		Class<?> annType = GenericTypeResolver.resolveTypeArgument(getClass(), AdviceModeImportSelector.class);
		Assert.state(annType != null, "Unresolvable type argument for AdviceModeImportSelector");
		// annType = EnableTransactionManagement注解的全限定名
		// importingClassMetadata :为config配置类中的所有的元数据
		// attributes:为EnableTransactionManagement注解中三个方法的返回值
